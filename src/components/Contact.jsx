...
/** Instagram */
  ...
  /** Email */
  {
    href: 'mailto:sonikrish2248@gmail.com',
    icon: <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4 4H21C22.1 4 23 4.9 23 6V18C23 19.1 22.1 20 21 20H4C2.9 20 2 19.1 2 18V6C2 4.9 2.9 4 4 4ZM4 6V18H21V6L12.5 12L4 6ZM12.5 10L21 6H4L12.5 10Z" fill="currentColor"/>
    </svg>,
    alt: 'Email'
  },
    ...
    >
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <h2 className="headline-2 lg:max-w-[50ch] reveal-up">
          Open to : <br />
          Full-time roles & <br/> Internship opportunities.
          </h2>
<br />
          <p className="text-black mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
           I&apos;m very excited to grow and contribute.
          </p>
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-white hover:text-black active:bg-zinc-50/80 reveal-up"
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action="https://getform.io/f/bolmgvka"
          method="POST"
